...
namespace ufshop.Migrations
{
    ...
    [Migration("20251206144144_202512061541")]
    partial class _202512061541
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ufshop.Data.Models.CartItemProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("CartItemProperty");
                });

            modelBuilder.Entity("ufshop.Data.Models.CartItemPropertyOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<Guid?>("CartItemPropertyId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CartItemPropertyId");

                    b.ToTable("CartItemPropertyOption");
                });
            ...
            modelBuilder.Entity("ufshop.Data.Models.CartItemPropertyOption", b =>
                {
                    b.HasOne("ufshop.Data.Models.CartItemProperty", null)
                        .WithMany("Options")
                        .HasForeignKey("CartItemPropertyId");
                });
